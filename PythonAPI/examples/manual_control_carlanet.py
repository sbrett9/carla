...
# CarlaNet-targeted variant of manual_control.py.
# This file is a near byte-for-byte copy of the upstream PythonAPI/examples/manual_control.py,
...
from carlanet import ColorConverter as cc
